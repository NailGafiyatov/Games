...
public class Rocket extends GameObject {
    ...
    public Rocket(double x, double y) {
        ...
        downFire = new RocketFire(listDown);

        ArrayList listSide1 = new ArrayList();
        listSide1.add(ShapeMatrix.FIRE_SIDE_1);
        listSide1.add(ShapeMatrix.FIRE_SIDE_2);
        leftFire = new RocketFire(listSide1);

        ArrayList listSide2 = new ArrayList();
        listSide2.add(ShapeMatrix.FIRE_SIDE_1);
        listSide2.add(ShapeMatrix.FIRE_SIDE_2);
        rightFire = new RocketFire(listSide2);
    }
